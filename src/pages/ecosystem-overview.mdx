...
description: "Aiken is a functional programming language for Cardano smart contracts that compiles to Untyped Plutus Core (UPLC). The ecosystem overview compares the alternative languages for writing Cardano validators — including PlutusTx (Haskell-based), OpShin (Python-based), Helios (JavaScript-based), and Plu-ts (TypeScript-based) — and clarifies that all ultimately compile to UPLC. Helps developers understand how Aiken fits alongside other Cardano development tools."
difficulty: "beginner"
...
machine](https://github.com/aiken-lang/aiken/blob/main/crates/uplc/src/machine.rs#L63)
written in Rust.
...
As a language, Helios is also purely functional but has limited type
...
have been. There is no <a href = "https://wiki.haskell.org/Template_Haskell">Template Haskell</a> involved.
