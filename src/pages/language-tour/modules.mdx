---
title: "Modules"
description: "Aiken is a functional programming language for Cardano smart contracts where code is organized into reusable bundles called modules. Modules are files containing functions, types, and constants, with their namespace determined by file path. Used to structure projects, share code between validators, import the standard library, and control visibility with pub."
difficulty: "beginner"
keywords: ["modules", "use", "import", "pub", "namespace", "opaque types", "standard library", "stdlib", "prelude", "aiken.toml", "dependencies"]
topics: ["modules", "imports", "namespaces", "visibility", "stdlib"]
prerequisites: ["functions", "custom-types"]
related: ["functions", "custom-types", "tests"]
---
