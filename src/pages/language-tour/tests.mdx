---
title: "Tests"
description: "Aiken is a functional programming language for Cardano smart contracts with first-class support for unit tests and property-based tests. Tests are written using the test keyword as named functions that return a Bool, and they execute on the same Plutus virtual machine used on-chain. Used to verify validator logic, run property-based tests with fuzzers, and measure execution costs."
difficulty: "intermediate"
keywords: ["test", "unit tests", "property-based tests", "fuzzers", "Fuzzer", "aiken check", "execution costs", "memory", "CPU", "testing validators"]
topics: ["tests", "unit-tests", "property-based-tests", "fuzzers"]
prerequisites: ["functions", "control-flow", "validators"]
related: ["bench", "troubleshooting", "validators"]
---
