---
title: "Custom Types"
description: "Aiken is a functional programming language for Cardano smart contracts with a strong static type system. Custom types are named collections of fields defined with the type keyword, supporting records, enums, generics, and algebraic data types — similar to structs and enums in Rust. Used to define datums, redeemers, and any structured data validators need to process on-chain."
difficulty: "beginner"
keywords: ["type", "custom types", "records", "enums", "constructors", "algebraic data types", "generics", "destructuring", "opaque types", "Data", "datum", "redeemer"]
topics: ["custom-types", "records", "enums", "algebraic-data-types", "generics"]
prerequisites: ["primitive-types", "functions"]
related: ["control-flow", "validators", "primitive-types"]
---
...
Let's consider another example with a `Box{:ak}` type, which is a simple record that
...
Values can be _destructured_ in Aiken. Destructuring is the opposite of
