---
title: "Functions"
description: "Aiken is a functional programming language for Cardano smart contracts where functions are first-class values. Functions are defined using the fn keyword with typed arguments and an implicit return. Used to structure validator logic, build reusable libraries, and compose operations via the pipe operator, anonymous functions, and backpassing."
difficulty: "beginner"
keywords: ["fn", "functions", "anonymous functions", "pipe operator", "backpassing", "labeled arguments", "generics", "type variables", "first-class functions"]
topics: ["functions", "fn", "pipe-operator", "backpassing", "anonymous-functions"]
prerequisites: ["primitive-types", "variables-and-constants"]
related: ["control-flow", "modules", "validators"]
---
