...
In fact, since `1.0.30-alpha` traces are no longer limited to strings. You can trace any _serialisable_ value auto-magically. The values will be traced using the [diagnostic notation described below](#cbor-diagnostic).
