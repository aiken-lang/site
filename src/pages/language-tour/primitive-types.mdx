...
description: "Aiken is a functional programming language for writing Cardano smart contracts that compiles to Plutus Core. Primitive types are the 6 built-in data types (Bool, Int, String, ByteArray, Data, and Void) plus base building blocks like Lists, Tuples, Options, and Pairs — the fundamental building blocks for defining validator logic, transaction data, and on-chain state."
difficulty: "beginner"
