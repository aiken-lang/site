...
And [standard library](https://aiken-lang.github.io/stdlib/) often defines `compare` function corresponding to different types, for instance, to compare two `ByteArray`s one can use this [`compare`](https://aiken-lang.github.io/stdlib/aiken/primitive/bytearray.html#compare) function.
