...
<Callout type="info">
  You setup a new Python environment for [PyCardano][] as follows:
...
signing_me.save("me.sk")

verification_key = PaymentVerificationKey.from_signing_key(signing_key)

address = Address(payment_part=verification_me.hash(), network=Network.TESTNET)
...
```py filename="hello-world-lock.py" {5, 8-19, 26-28}
from pycardano import (
    BlockFrostChainContext,
    PaymentSigningKey,
)
...
```py filename="hello-world-lock.py" {1, 3, 5, 7-11, 13-17, 33-65, 67-70, 81, 83, 85-91, 93-95}
...
```py filename="hello-world-unlock.py" {2, 4, 6, 10, 25-29, 40-44}
from pycardano import (
    Address,
    BlockFrostChainContext,
    Network,
...
```py filename="hello-world-unlock.py" {1, 7-12, 15-19, 37-70, 78-81, 98-99, 101-109, 111-113}
from dataclasses import dataclass
from pycardano import (
    Address,
    BlockFrostChainContext,
