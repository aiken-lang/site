...
Note that the highlighted line above looks Blockfrost project ID, so we create a file named `bf.key` and add your Blockfrost project ID to it.

```console filename="bf.key"
preview...
```
