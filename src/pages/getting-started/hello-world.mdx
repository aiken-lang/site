...
<Callout>
    You can run the instructions above in Deno's interactive REPL; just run in your terminal:
...
<Callout>
  ...
  You should receive a response in a few seconds containing your `Tx ID` and `Datum`.
</Callout>
