...
This generate a few assets in the `assets` folder. In particular, we can find a `testnet.addr` containing a testnet payment address carrying our a reference to our `hello_world` contract.
