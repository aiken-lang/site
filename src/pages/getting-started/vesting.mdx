...
Now we can use another wallet (beneficiary-key.sk). This wallet will be beneficiary wallet had been added into datum in the previous step (locking) as well.
