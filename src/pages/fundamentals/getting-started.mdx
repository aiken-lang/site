...
description: "Aiken is a functional programming language and toolchain for writing Cardano smart contracts. Getting started covers installing the aikup version manager and aiken CLI, scaffolding a new project with aiken new, understanding the project structure (aiken.toml, lib/, validators/), and key commands like aiken build, aiken check, and aiken docs. The entry point for new developers to set up their environment and begin writing validators."
difficulty: "beginner"
keywords: ["getting started", "installation", "aikup", "aiken new", "aiken build", "aiken check", "aiken docs", "aiken.toml", "project structure", "setup", "stdlib", "standard library"]
topics: ["getting-started", "installation", "project-setup", "cli"]
prerequisites: []
related: ["eutxo", "primitive-types", "validators"]
---
...
- [ ] Join the [#aiken channel on Discord](https://discord.gg/JnWjkrErJr).
...
### Aiken's testing library

The [`aiken-lang/fuzz`](https://aiken-lang.github.io/fuzz/) library enables any developer to write Aiken fuzzers (a.k.a
generators) for deeply testing smart contracts.

It provides many useful primitives for writing and composing arbitrary
generators in the context of property-based testing; and comes with a framework
for writing high-level state machines operating at the transaction-level.

## Other community packages

For more packages from the Aiken community, check out [Aiken's package registry](https://packages.aiken-lang.org).
