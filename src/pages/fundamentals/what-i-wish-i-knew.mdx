...
description: "Aiken is a functional programming language for Cardano smart contracts. This page is a curated collection of tips, gotchas, and hard-won knowledge about the Cardano ecosystem — covering reliable documentation sources, ledger quirks, CBOR serialisation subtleties, native scripts, reward accounts, address formats, and common debugging pitfalls. Saves developers hours of debugging by surfacing non-obvious details of building on Cardano."
difficulty: "intermediate"
keywords: ["tips", "gotchas", "CBOR", "CDDL", "native scripts", "addresses", "reward accounts", "script hash", "ledger quirks", "debugging", "Cardano Developer Portal"]
topics: ["tips", "gotchas", "cardano-internals", "debugging", "addresses"]
prerequisites: ["eutxo", "getting-started"]
related: ["common-design-patterns", "troubleshooting", "eutxo"]
---
