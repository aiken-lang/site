...
number of blocks is given by the following equation:

<br/><img src="/settlement_error_probability.light.svg"  class="light" /><img src="/settlement_error_probability.dark.svg"   class="dark" />
