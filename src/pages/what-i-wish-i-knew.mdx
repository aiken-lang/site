...
Outputs locked by a Byron address or inputs corresponding to such outputs
are **absent** from script contexts! This makes any validator completely blind
to Byron addresses which may lead to confusing situations if you aren't
careful about your validation logic.
</Callout>
