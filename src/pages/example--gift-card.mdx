...
- using [lucid](https://lucid.spacebudz.io/) (requires a [blockfrost](https://blockfrost.io/) account)
...
```tsx filename="islands/Oneshot.tsx" {2,10-12,20-81,89-122} showLineNumbers
// ... other imports ...
