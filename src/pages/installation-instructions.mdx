...
```sh
cargo install --version 1.0.4-alpha
```
...
<Callout type="warning">
  `1.0.4-alpha` may not be the latest version. To install the latest version,
  find the latest version number on
  [crates.io](https://crates.io/crates/aiken/versions) and replace `1.0.4-alpha`
