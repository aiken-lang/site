...
Let's start with a little reminder about the syntax. The complete syntax for Untyped Plutus Core comes from the original [Formal Specification of the Plutus Core Language](/resources/plutus-core-specification.pdf).
...
take one, two, three or really any number of arguments. Here is the complete list of <a href="https://aiken-lang.org/uplc/builtins">Builtins</a>.
